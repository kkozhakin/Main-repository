...
public class ImmutableParentNode<T>
    ...
    /**
     * Constructor - create new object with value, parent and children.
     * @param object value
     ...
     * @see ImmutableParentNode#containsDescendants(Object)
     */
    @Override
     ...
     * @param childValue value
     * @return contains or not
     * @see ImmutableParentNode#contains(Object)
     */
    @Override
    ...
    public String toStringForm(String indent) {
        StringBuilder s = new StringBuilder(indent + "ImmutableParentNode(" + getObject().toString() + ")\n");
        @SuppressWarnings("unchecked")
        AbstractTreeNode<T>[] childrenarr = new AbstractTreeNode[children.size()];
        children.toArray(childrenarr);
        for (AbstractTreeNode<T> tAbstractTreeNode : childrenarr)
