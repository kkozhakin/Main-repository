...
class PiSpigot {
    ...
    /**Realization of spigot algorighm: for explanation see
    ...
    public String result(){
        ...
        for(int i = 1; i <piDigits.length; i++)
            res.append(Integer.toString(piDigits[i]));
        return res.toString();
    }
}
...
//        new PiSpigot(userAns).print();
        long t0 = System.nanoTime();
        PiSpigot piSpigot = new PiSpigot(userAns);
        long t1 = System.nanoTime();
        piSpigot.print();
        System.out.println("Pi calculated in " + (t1 - t0)/1000000F + " msec.");
    }
}